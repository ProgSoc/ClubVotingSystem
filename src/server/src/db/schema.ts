...
export const roomUser = pgTable(
  'RoomUser',
  {
    ...
    roomId: text('roomId')
      .notNull()
      .references(() => room.id, { onDelete: 'restrict', onUpdate: 'cascade' }),
...
export const questionInteraction = pgTable(
  'QuestionInteraction',
  {
    questionId: text('questionId')
      .notNull()
      .references(() => question.id, { onDelete: 'restrict', onUpdate: 'cascade' }),
    voterId: text('voterId')
      .notNull()
      .references(() => voter.id, { onDelete: 'restrict', onUpdate: 'cascade' }),
  },
  (table) => {
    return {
...
export const candidateVote = pgTable(
  'CandidateVote',
  {
    candidateId: text('candidateId')
      .notNull()
      .references(() => questionCandidate.id, { onDelete: 'restrict', onUpdate: 'cascade' }),
    voterId: text('voterId')
      .notNull()
      .references(() => voter.id, { onDelete: 'restrict', onUpdate: 'cascade' }),
  },
