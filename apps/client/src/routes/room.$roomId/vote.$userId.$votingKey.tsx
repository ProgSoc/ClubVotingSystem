...
import {
	type QuestionVotingData,
	useVoterState,
	VotingPageState,
} from "hooks/votingPageHooks";
...
function SingleQuestionVoting({ data }: { data: QuestionVotingData }) {
	...
	const candidatesReordered = useMemo(
		() => secureShuffle(question.candidates, randomSeed),
		[randomSeed, question.candidates],
	);
