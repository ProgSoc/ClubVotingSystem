...
export function CenteredPageContainer({ children, className }: BaseProps) {
	return (
		<div
			className={twMerge(
				"flex flex-col items-center justify-center text-center min-h-screen w-screen p-16",
				className,
			)}
		>
			{children}
...
export function PageContainer({ children, className }: BaseProps) {
	return (
		<div
			className={twMerge(
				"flex flex-col items-center text-center min-h-screen w-screen p-16",
				className,
			)}
		>
			{children}
...
export function Heading({ children, className }: BaseProps) {
	return (
		<h1 className={twMerge("text-2xl md:text-4xl font-bold", className)}>
			{children}
		</h1>
	);
}
...
export function Question({ children, className }: BaseProps) {
	return (
		<h1 className={twMerge("text-2xl font-bold text-info", className)}>
			{children}
		</h1>
	);
}
